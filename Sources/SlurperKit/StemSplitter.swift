...
/// yt-dlp fetches the audio (or a local file is decoded), Mel-Band RoFormer on Core AI separates the vocals,
/// and htdemucs on Core AI splits the instrumental (mix minus vocals) into drums, bass and other.
public enum StemSplitter {
    ...
    static let vocalModel = modelsDirectory.appending(path: "MelBandRoformer-Vocal-CoreAI/mbr_full_fp16.aimodel", directoryHint: .isDirectory)
    static let demucsModel = modelsDirectory.appending(path: "htdemucs-CoreAI/htdemucs_fp32.aimodel", directoryHint: .isDirectory)

    static let roformerRepo = "mlboydaisuke/MelBandRoformer-Vocal-CoreAI"
    static let roformerRevision = "5cf0e04d08569f4d2f5d89d500a8fb943894330f"
    static let demucsRepo = "TrevorJS/htdemucs-CoreAI"
    static let demucsRevision = "5b926cd8b2d2f8299eda2f01daf9063d358962e8"
    ...
    private static let modelFiles = [
        ModelFile(repo: roformerRepo, revision: roformerRevision, folder: "MelBandRoformer-Vocal-CoreAI",
                  path: "mbr_full_fp16.aimodel/metadata.json", bytes: 1_000),
        ModelFile(repo: roformerRepo, revision: roformerRevision, folder: "MelBandRoformer-Vocal-CoreAI",
                  path: "mbr_full_fp16.aimodel/main.hash", bytes: 100),
        ModelFile(repo: roformerRepo, revision: roformerRevision, folder: "MelBandRoformer-Vocal-CoreAI",
                  path: "mbr_full_fp16.aimodel/main.mlirb", bytes: 492_600_000),
        ModelFile(repo: demucsRepo, revision: demucsRevision, folder: "htdemucs-CoreAI",
                  path: "htdemucs_fp32.aimodel/metadata.json", bytes: 105),
        ModelFile(repo: demucsRepo, revision: demucsRevision, folder: "htdemucs-CoreAI",
                  path: "htdemucs_fp32.aimodel/main.hash", bytes: 32),
        ModelFile(repo: demucsRepo, revision: demucsRevision, folder: "htdemucs-CoreAI",
                  path: "htdemucs_fp32.aimodel/main.mlirb", bytes: 168_673_164),
    ]
